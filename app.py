...
def handle_message(event):
    ...
    Video_Message = VideoSendMessage(original_content_url='https://jylin.myqnapcloud.com/test.mp4', preview_image_url='https://a.ksd-i.com/a/2016-11-30/87867-477547.jpg')
    ...
    Imagemap_Message = ImagemapSendMessage(
        base_url='https://i.ytimg.com/vi/sGRv8ZBLuW0/hqdefault.jpg?sqp=-oaymwEZCPYBEIoBSFXyq4qpAwsIARUAAIhCGAFwAQ==&rs=AOn4CLC6biRlKYBPBR1AeKXrlLQRYpovXQ#',
